...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-4">
            <!-- Search Bar -->
            <form action="<?php echo e(route('admin.daftar.index')); ?>" method="GET" class="relative">
                <input 
                    type="text" 
                    name="search"
            ...
            <a href="<?php echo e(route('admin.daftar.create')); ?>" 
    ...
    <div class="bg-white rounded-lg overflow-hidden">
        ...
        <div class="grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-1 flex gap-2 justify-end">
                <!-- Edit Button -->
                <a href="<?php echo e(route('admin.daftar.edit', $data->id)); ?>" 
                ...
                <!-- Delete Button -->
                <form action="<?php echo e(route('admin.daftar.destroy', $data->id)); ?>" 
                      method="POST" 
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-6\Polcabot-6\resources\views/admin/daftar/index.blade.php ENDPATH**/ ?>
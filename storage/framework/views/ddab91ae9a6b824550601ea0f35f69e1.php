<?php $__env->startSection('title', 'Chat - PolCaBot'); ?>
...
function showTypingIndicator() {
  ...
  typingDiv.innerHTML = `
    <div class="message-avatar">
      <img src="<?php echo e(asset("images/logo.png")); ?>" alt="Bot" width="40" height="40" style="width:40px;height:40px;">
    </div>
    <div class="message-group">
...
async function sendMessage() {
  ...
  try {
    // Send to backend
    const response = await fetch('<?php echo e(url("/chatbot/send")); ?>', {
      method: 'POST',
      headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-6\Polcabot-6\resources\views/pages/chat.blade.php ENDPATH**/ ?>
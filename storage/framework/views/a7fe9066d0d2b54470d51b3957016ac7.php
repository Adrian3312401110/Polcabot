...
async function openEditModal() {
  ...
  try {
    const response = await fetch('<?php echo e(route("admin.training.get")); ?>');
    const data = await response.json();
...
function savePrompt() {
  ...
  fetch('<?php echo e(route("admin.training.update")); ?>', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function resetToDefault() {
  ...
  fetch('<?php echo e(route("admin.training.reset")); ?>', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-6\Polcabot-6\resources\views/admin/training.blade.php ENDPATH**/ ?>
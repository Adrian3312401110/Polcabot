...
function deleteChat(index) {
    ...
    if (!document.querySelectorAll(".chat-history-item").length) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (saved.length > 0 && list.children.length <= 1) {
        saved.forEach((txt, i) => {
            const li = document.createElement("li");
            li.className = "chat-history-item";
            li.dataset.chat = txt;
            li.innerHTML = `
                <span class="chat-text">${txt}</span>
                <button class="delete-chat-btn"
                onclick="event.stopPropagation(); deleteChat(${i})">
...
<?php /**PATH C:\laragon\www\Polcabot-9\resources\views/components/sidebar.blade.php ENDPATH**/ ?>
...
async function sendMessage() {
  ...
  try {
    // Send to backend
    const response = await fetch('<?php echo e(url("/chat/send")); ?>', {
      method: 'POST',
      headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-5\resources\views/pages/chat.blade.php ENDPATH**/ ?>
  ...
  <div class="relative w-full max-w-6xl flex bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden">
    ...
    <div class="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
      <div class="w-full max-w-md mx-auto">
        ...
        <h2 class="text-4xl font-bold text-slate-900 mb-2">Mulailah Sekarang</h2>
        <p class="text-slate-600 mb-8">Selamat datang kembali! Silakan masukkan detail Anda.</p>
        ...
        <form method="POST" action="<?php echo e(route('login.submit')); ?>" class="space-y-5">
          ...
          <p class="text-center text-slate-600">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-blue-600 font-semibold hover:text-blue-700 transition-colors">Register</a>
          </p>
        </form>

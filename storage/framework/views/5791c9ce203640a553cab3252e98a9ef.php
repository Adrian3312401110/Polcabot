...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('admin.jurusan.update', $dataset->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-6\Polcabot-6\resources\views/admin/jurusan/edit.blade.php ENDPATH**/ ?>
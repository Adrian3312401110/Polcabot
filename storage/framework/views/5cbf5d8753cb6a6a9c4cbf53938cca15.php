...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6 header-container">
        ...
        <div class="flex items-center gap-4 search-actions">
            <form action="<?php echo e(route('admin.jurusan.index')); ?>" method="GET" class="relative">
                <input 
                    type="text" 
                    name="search"
            ...
            <div class="action-buttons-mobile">
                ...
                <a href="<?php echo e(route('admin.jurusan.create')); ?>" 
    ...
    <div class="bg-white rounded-lg overflow-hidden shadow-sm">
        ...
        <div class="hidden md:grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-2 text-sm">
                <a href="<?php echo e($data->source); ?>" target="_blank" class="text-blue-600 hover:underline break-all">
            ...
            <div class="col-span-1 flex gap-2 justify-center">
                <a href="<?php echo e(route('admin.jurusan.edit', $data->id)); ?>" class="text-yellow-500 hover:text-yellow-600">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                    </svg>
                </a>
                <form action="<?php echo e(route('admin.jurusan.destroy', $data->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                    <?php echo csrf_field(); ?>
        ...
        <div class="md:hidden border-2 border-blue-300 rounded-lg mb-3 mx-2 mt-2 table-row-mobile">
            ...
            <div class="mobile-card-item">
                ...
                <a href="<?php echo e($data->source); ?>" target="_blank" class="mobile-value text-blue-600 hover:underline break-all">
                    <?php echo e(Str::limit($data->source, 30)); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-9\resources\views/admin/jurusan/index.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('admin.riwayat') }}" class="{{ request()->is('admin/riwayat') ? 'active' : '' }}">💬 Riwayat Chat</a>
        <a href="{{ route('admin.knowledge') }}" class="{{ request()->is('admin/knowledge') ? 'active' : '' }}">📚 Knowledge Base</a>
        <a href="{{ route('admin.training') }}" class="{{ request()->is('admin/training') ? 'active' : '' }}">🧠 Training AI</a>
        <a href="{{ route('admin.pengaturan') }}" class="{{ request()->is('admin/pengaturan') ? 'active' : '' }}">⚙️ Pengaturan</a>
    </div>

...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-4">
            <!-- Search Bar -->
            <form action="{{ route('admin.beasiswa.index') }}" method="GET" class="relative">
                <input 
                    type="text" 
                    name="search"
    ...
    <div class="bg-white rounded-lg overflow-hidden">
        ...
        <div class="grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-1 flex gap-2 justify-end">
                <!-- Edit Button -->
                <a href="{{ route('admin.beasiswa.edit', $data->id) }}" 
                ...
                <!-- Delete Button -->
                <form action="{{ route('admin.beasiwa.destroy', $data->id) }}" 
                      method="POST" 

...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-4">
            <!-- Search Bar -->
            <form action="{{ route('admin.organisasi.index') }}" method="GET" class="relative">
                <input 
                    type="text" 
                    name="search"
    ...
    <div class="bg-white rounded-lg overflow-hidden shadow-sm">
        ...
        <div class="grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-2 text-sm">
                {{ Str::limit($data->question, 60) }}
            </div>
            
            <!-- Answer -->
            <div class="col-span-2 text-sm">
                {{ Str::limit($data->answer, 60) }}
            </div>
            ...
            <div class="col-span-1 flex gap-2 justify-center">
                <!-- Edit Button -->
                <a href="{{ route('admin.organisasi.edit', $data->id) }}" 
                ...
                <!-- Delete Button -->
                <form action="{{ route('admin.organisasi.destroy', $data->id) }}" 
                      method="POST" 
